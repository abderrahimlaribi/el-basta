...
export default async function TeaRoomLanding() {
  // Fetch locations on the server so they are included in initial HTML
  let initialLocations: Location[] = []
  try {
    initialLocations = await getLocations()
  } catch (e) {
    // Fall back to empty (LocationSelector will attempt client fetch)
    initialLocations = []
  }
