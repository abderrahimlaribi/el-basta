        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-semibold text-amber-900 mb-4 font-body">3. Attendez votre livreur</h3>
              <p className="text-amber-700 leading-relaxed font-body">
                Détendez-vous et attendez que votre commande arrive. Savourez chaque moment de votre expérience chez
                ElBasta.
              </p>
            </div>
          </div>
